                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap items-center justify-start gap-5 md:justify-stretch">
                            ...
                            <div className="flex items-center justify-start gap-3 mt-5 md:flex-wrap">
                                ...
                                <h1 className="flex items-center justify-start gap-2 text-2xl font-bold tracking-tight text-yellow-500 transition-colors scroll-m-20 md:text-xl first:mt-0">{data.popularity.toFixed(2) ? data.popularity.toFixed(2) : "Popularity not found"} <FaRankingStar size={28} className="text-yellow-500 " /></h1>
                            </div>
                            <div className="flex items-center justify-start gap-3 mt-5 md:flex-wrap">
                                <h2 className="text-2xl font-bold black-shadow-text scroll-m-20 md:text-lg first:mt-0">Vote average :</h2>
                                <h1 className="flex items-center justify-start gap-2 text-2xl font-bold tracking-tight text-yellow-500 transition-colors scroll-m-20 md:text-xl first:mt-0">{data.vote_average ? data.vote_average : "Vote average not found"}<GiStarsStack size={28} className="text-yellow-500 " /></h1>
                            </div>
                        </div>
                        <div className="flex items-center justify-start gap-3 mt-5 md:flex-wrap lg:flex-wrap">
