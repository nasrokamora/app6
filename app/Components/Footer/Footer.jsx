    ...
    return (
        ...
        <aside>
            ...
            {/* <div className="flex justify-start items-start gap-4">
                <span className="footer-title">Magix Movies</span>
                <p>Magix Movies is a website that provides information and resources about movies.</p>
            </div> */}
            ...
            <footer className="footer">
                    <div className=" flex flex-col gap-2">
                        <Image src={TmdbIcon} alt="logo" width={100} height={100} />
