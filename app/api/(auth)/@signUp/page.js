...
export default function LogIn() {
    ...
    return (
        <div className=" flex gap-8 md:gap-2 font-bold  w-full justify-center items-center mb-2 -xl">
            ...
            <DropdownMenu >
            <DropdownMenuTrigger>
            <IoLogInOutline size={30} className="hover:scale-110 transition-transform duration-300 text-white"  />
            </DropdownMenuTrigger>
            <DropdownMenuContent className="w-auto">
                <DropdownMenuItem>
                    <LoginLink className="text-subtle">
                        Log in
                    </LoginLink>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem>
                    <RegisterLink className="text-subtle">
                        Sign up for free
                    </RegisterLink>
                </DropdownMenuItem>
            </DropdownMenuContent>
